...
echo no | android create avd --force -n $WERCKER_SETUP_ANDROID_EMULATOR_WITH_SDCARD_TARGET_NAME -t $WERCKER_SETUP_ANDROID_EMULATOR_WITH_SDCARD_TARGET --abi $WERCKER_SETUP_ANDROID_EMULATOR_WITH_SDCARD_ABI -c 256M
